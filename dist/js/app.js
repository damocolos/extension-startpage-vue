...
/* harmony export */   "addSpaceStar": () => (/* binding */ addSpaceStar),
/* harmony export */   "getSpaceStar": () => (/* binding */ getSpaceStar),
/* harmony export */   "updateSpaceStar": () => (/* binding */ updateSpaceStar)
/* harmony export */ });
...
var connection = axios__WEBPACK_IMPORTED_MODULE_1___default().create({
  baseURL: 'https://resilient-cat-092f6d.netlify.app/.netlify/functions/api' // baseURL: 'http://localhost:9000/.netlify/functions/api/',

});
var getSpaceStar = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return connection.get("spaces/star");
  ...
  return function getSpaceStar() {
    return _ref.apply(this, arguments);
  };
}();
var updateSpaceStar = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return connection.put("spaces/star/".concat(id), data);
  ...
  return function updateSpaceStar(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();
var addSpaceStar = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return connection.post("spaces/star", data);
  ...
  return function addSpaceStar(_x3) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./assets/js/components/App.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./assets/js/components/App.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/api.js */ "./assets/js/utils/api.js");
          ...
          switch (_context.prev = _context.next) {
            case 0:
              chrome.storage.sync.get(['siteList'], function (result) {
                _this.list = result.siteList;
                _this.importData = JSON.stringify(result.siteList);
              });
              _context.next = 3;
              return (0,_utils_api_js__WEBPACK_IMPORTED_MODULE_1__.getSpaceStar)();

            case 3:
              stars = _context.sent;

              if (stars && stars.length) {
                data = stars.map(function (s) {
                  return s.data;
                });
                _this.list = data;
                _this.importData = JSON.stringify(data);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_App_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./App.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./assets/js/components/App.vue?vue&type=script&lang=js&");
...
var render = function () {
  ...
  return _c("section", [
    ...
    _vm._v(" "),
    _vm.showPopupSetting
      ? _c("div", { staticClass: "popup-setting" }, [
          _c("div", { staticClass: "popup-setting-content" }, [
            _c(
              "table",
              [
                _vm._m(0),
                _vm._v(" "),
                _vm._l(_vm.list, function (item, index) {
                  return _c("tr", { key: "setting-" + index }, [
                    _c("td", [
                      _c("input", {
                        directives: [
                          {
                    ...
                    _c("td", [
                      _c("input", {
                        ...
                        domProps: { value: item.class },
                        on: {
                          input: function ($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(item, "class", $event.target.value)
                          },
                        },
                      }),
                    ]),
            ...
            _c("div", { staticClass: "button-wrapper" }, [
              _c(
                "button",
                { staticClass: "button", on: { click: _vm.onAdd } },
                [_vm._v("Add")]
              ),
              _vm._v(" "),
              _c(
                "button",
                { staticClass: "button", on: { click: _vm.onSave } },
                [_vm._v("Save")]
              ),
            ]),
            _vm._v(" "),
            ...
            _c("div", { staticClass: "button-wrapper" }, [
              _c(
                "button",
                { staticClass: "button", on: { click: _vm.onImport } },
                [_vm._v("Import")]
              ),
            ]),
          ]),
    ...
    _c(
      "button",
      { staticClass: "setting-toggle button", on: { click: _vm.togglePopup } },
      [
        _vm._v(
          "\n    " + _vm._s(_vm.showPopupSetting ? "Close" : "Setting") + "\n  "
        ),
      ]
    ),
  ])
...
/* harmony import */ var _components_App_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/App.vue */ "./assets/js/components/App.vue");


var app = new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
  el: '#app',
  render: function render(createElement) {
    return createElement(_components_App_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }
});
})();
